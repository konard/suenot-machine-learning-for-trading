# Chapter 316: Trajectory Transformer

## Описание

Trajectory Transformer для planning через generation.
...
1. **Offline RL as One Big Sequence Modeling Problem**
   - URL: https://arxiv.org/abs/2106.02039
   - Год: 2021

## Структура
```
316_trajectory_transformer/
├── README.specify.md
├── docs/ru/
├── python/
└── rust/src/
