# Chapter 338: Energy-Based Models Trading

## Описание

EBMs для flexible probabilistic modeling.
...
1. **Your Classifier is Secretly an Energy Based Model**
   - URL: https://arxiv.org/abs/1912.03263
   - Год: 2019

## Структура
```
338_energy_based_models/
├── README.specify.md
├── docs/ru/
├── python/
└── rust/src/
