# Chapter 72: LLM Market Simulation

## Описание

Симуляция рыночных условий с помощью LLM agents.
...
1. **Can Large Language Models Trade? Testing Financial Theories with LLM Agents**
