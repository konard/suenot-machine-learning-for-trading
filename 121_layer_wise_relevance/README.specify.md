# Chapter 121: Layer-wise Relevance Propagation

## Описание

LRP для декомпозиции предсказаний по входным признакам.
...
1. **Layer-Wise Relevance Propagation: An Overview**
