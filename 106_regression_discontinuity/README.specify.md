# Chapter 106: Regression Discontinuity Trading

## Описание

RDD для оценки эффектов на пороговых значениях в торговле.
...
1. **Regression Discontinuity Designs: A Guide to Practice**
   - URL: https://www.nber.org/papers/w13039
   - Год: 2007
