# Chapter 269: Liquidity Prediction

## Описание

Предсказание ликвидности с помощью ML.
...
1. **Deep Learning for Liquidity Prediction**
   - URL: https://arxiv.org/abs/2012.08215
   - Год: 2020

## Структура
```
269_liquidity_prediction/
├── README.specify.md
├── docs/ru/
├── python/
└── rust/src/
