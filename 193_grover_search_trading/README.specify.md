# Chapter 193: Grover Search для Trading

## Описание

Алгоритм Гровера для поиска оптимальных торговых стратегий.
...
1. **Quantum Algorithms for Portfolio Optimization**
   - URL: https://arxiv.org/abs/2102.02061
   - Год: 2021
