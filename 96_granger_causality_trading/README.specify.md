# Chapter 96: Granger Causality для Trading

## Описание

Тест Грейнджера для определения причинно-следственных связей между активами.
...
1. **Trading with Time Series Causal Discovery**
