# Chapter 152: Operator Learning для Finance

## Описание

Обучение операторов для решения семейств финансовых PDE.
...
1. **Learning Nonlinear Operators via DeepONet**
