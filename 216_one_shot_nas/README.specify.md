# Chapter 216: One-Shot NAS

## Описание

One-shot методы для быстрого поиска архитектур.
...
1. **Understanding and Simplifying One-Shot Architecture Search**
   - URL: https://arxiv.org/abs/1810.01129
   - Год: 2018
