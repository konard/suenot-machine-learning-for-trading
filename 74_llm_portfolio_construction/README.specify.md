...
Построение портфелей с помощью LLM на основе анализа фундаментальных данных.
...
1. **Large Language Models for Financial and Investment Management**
   - URL: https://web.media.mit.edu/~xdong/paper/jpm24b.pdf
   - Год: 2024
