# Chapter 151: Physics-Constrained GAN

## Описание

GAN с физическими ограничениями для генерации реалистичных финансовых данных.
...
1. **Physics-Constrained Generative Adversarial Networks**
   - URL: https://arxiv.org/abs/2012.11145
   - Год: 2020
