# Chapter 48: Positional Encoding для Time Series

## Описание

Специализированные positional encodings для временных рядов: learned, sinusoidal, relative, rotary.
...
## Структура
```
48_positional_encoding_timeseries/
├── README.specify.md
├── README.md
├── docs/
│   └── ru/
