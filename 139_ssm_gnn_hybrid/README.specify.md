# Chapter 139: SSM-GNN Hybrid

## Описание

Комбинация SSM и Graph Neural Networks для структурированных данных.
...
1. **Graph State Space Models**
   - URL: https://arxiv.org/abs/2301.01731
   - Год: 2023
