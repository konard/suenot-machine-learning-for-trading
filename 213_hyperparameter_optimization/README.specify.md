# Chapter 213: Hyperparameter Optimization

## Описание

Оптимизация гиперпараметров для торговых моделей.
...
1. **Hyperparameter Optimization: A Survey**
...
## Структура
```
213_hyperparameter_optimization/
├── README.specify.md
├── docs/ru/
├── python/
└── rust/src/
