...
Model inversion attacks для извлечения приватных данных.
...
1. **Model Inversion Attacks that Exploit Confidence Information**
   - URL: https://arxiv.org/abs/1507.05727
   - Год: 2015

## Структура
```
229_model_inversion_finance/
├── README.specify.md
├── docs/ru/
├── python/
└── rust/src/
