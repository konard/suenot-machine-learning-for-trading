# Chapter 104: Synthetic Control для Trading

## Описание

Метод синтетического контроля для оценки влияния событий на рынки.
...
1. **Synthetic Control Methods for Comparative Case Studies**
