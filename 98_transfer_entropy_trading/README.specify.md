# Chapter 98: Transfer Entropy для Trading

## Описание

Transfer Entropy для измерения информационного потока между активами.
...
1. **Effective Transfer Entropy for Causal Discovery**
