# Chapter 280: Reinforcement LOB

## Описание

Reinforcement Learning для LOB trading.
...
1. **Deep Reinforcement Learning for LOB Trading**
   - URL: https://arxiv.org/abs/2003.05941
   - Год: 2020

## Структура
```
280_reinforcement_lob/
├── README.specify.md
├── docs/ru/
├── python/
└── rust/src/
