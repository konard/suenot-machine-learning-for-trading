# Chapter 312: Planning в RL Trading

## Описание

Planning algorithms для optimal execution.
...
1. **Reinforcement Learning with Model Learning and Planning**
   - URL: https://arxiv.org/abs/2206.01878
   - Год: 2022

## Структура
```
312_planning_rl_trading/
├── README.specify.md
├── docs/ru/
├── python/
└── rust/src/
